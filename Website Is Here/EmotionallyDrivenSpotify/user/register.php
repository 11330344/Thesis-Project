   ...
   <div class="signin"> 
    ...
    <div class="content"> 
     ...
     <div class="form"> 
      ...
      <input type="text" name="name" placeholder="Name" required><i>Name</i> 

      </div> 

      <div class="inputBox"> 

      <input type="text" name="username" placeholder="Username" required><i>User Name</i> 
      ...
      <div class="links"> <a href="index.php">Login</a>
